...
$userid = $_GET['id'];
$sql = "UPDATE userdb SET Status='Reject' WHERE UserID=$userid";
...
<head>
    <meta charset="utf-8">
    <title>Updated Reject Successfully</title>
...
<body>
        ...
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                ...
                <div class="d-inline-flex text-white">
                    ...
                    <p class="m-0 text-uppercase">Updated Merchant Status to Reject Successfully</p>
                </div>
            </div>
        </div>
    </div>
    ...
    ?>
                ...
                <h3>Updated Merchant Status to 'Reject' Successfully</h3>
                <h5>An email is sent to <?php echo $email; ?> letting them know their account is rejected.<h5>
