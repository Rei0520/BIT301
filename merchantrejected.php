...
if ($result) {
    echo "Update merchant status to 'Reject' successful.";
} else {
    ...
    <div class="container-fluid py-5">
        <div class="container pb-3">
            <div class="text-center mb-3 pb-3">
                ...
                <td><a class="delete btn btn-primary" href="editmanage.php?editmanage.php?id=<?php echo $rows['Status']; ?>">Approve</a></td>
                <td><a class="delete btn btn-danger" href="editmanage.php?id=<?php echo $rows['Status']; ?>">Reject</a></td>
                </tr>
	<?php
