        ...
        <div class="col-6 bg-white rounded" style="padding: 30px 30px 30px 30px;">
            <form method="POST" id="registerForm" action="register.php">
                ...
                <div class="form-group form-inline">
                  ...
                  <div class="form-group form-inline">
                    <label for="password" class="col-lg-2 text-right" style="justify-content: flex-end;">Password:</label>
                    <input type="text" class="form-control sizing col-lg-10" id="password" name="password" placeholder="Enter password" required>
                  </div>
                  <div class="form-group form-inline">
                    <label for="contactNum" class="col-lg-2 text-right" style="justify-content: flex-end;">Contact Number:</label>
                    <input type="text" class="form-control sizing col-lg-10" id="contactNum" name="contactNum" placeholder="Enter contact number" required>
                  </div>
                  <div class="form-group form-inline">
                  ...
                  <div class="form-group form-inline">
                    <label for="description" class="col-lg-2 text-right" style="justify-content: flex-end;">Company Description:</label>
                    <textarea rows="5" cols="40" type="text" class="form-control sizing col-lg-10" id="description" name="description" required></textarea>
                  </div>
                  <div class="form-group form-inline">
                    <label for="document" class="col-lg-2 text-right" style="justify-content: flex-end;">Document:</label>
                    <input type="file" class="form-control sizing col-lg-10" id="document" name="document" placeholder="Enter password" required>
                  </div>
