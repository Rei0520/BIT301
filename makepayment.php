...
// Formulate query
$query = "SELECT product_name, price From new_product WHERE id = $id";
...
<body>
        ...
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                ...
                <div class="d-inline-flex text-white">
                    ...
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Make Payment</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="margin-right: 300px; margin-left: 300px;" class="row">
        <!-- Left Side Column -->
        <div class="col-md-6 d-flex justify-content-center">
            <!-- Content for the left side -->
            <div>
                <form method="POST" action="message&receipt.php" class="form-signin">
                    
                    <div class="form-label-group">
                        
                        <h5><br><br>Please select payment method: </h5>
                            <input type="radio" id="radio" name="payment" value="Grab Pay">
                            <label>Grab Pay</label>
                            <img style="width: 90px; height: 45px; margin-left: 200px;" class="radio-img" src="uploads_img/grabpay.png" alt="Radio Button Image"><br>
                            <input type="radio" id="radio" name="payment" value="Online Banking">
    ...
    ?>
                   ...
                   <tr>
                    ...
                    <tr>
                    <td>Total price:
                    <td><?php  $total_price = $Quantity*$rows['price']; echo "RM", $total_price;  $_SESSION['total_price'] = $total_price;?></td>
                    </tr>
                    <?php
}
?>
